    ...
    keyFindings: {
      ...
      items: {
        ...
        properties: {
          ...
          affectedBodyPart: {
            type: Type.STRING,
            enum: ["head", "heart", "lungs", "liver", "kidneys", "stomach", "blood", "general"],
            description: "The primary body part or system related to this finding. Use 'general' or 'blood' for systemic issues. This is CRUCIAL for patient visualization."
          }
        },
...
const getSystemInstruction = (mode: ChatMode): string => {
  ...
  - 'affectedBodyPart': For each 'keyFinding', you MUST populate the 'affectedBodyPart' field using one of the allowed enum values. This is crucial for creating a visual summary for the patient. Choose the most relevant organ. If the finding is systemic (e.g., 'fever', 'fatigue') use 'general'. For blood tests like CBC, use 'blood'.
